...
const W = (path: string, file: string) =>
  `https://upload.wikimedia.org/wikipedia/commons/thumb/${path}/${file}/640px-${file}`;
...
export const BIRD_SPECIES_CATALOG: Record<string, BirdSpeciesInfo> = {
  댕기머리물떼새: {
    ...
    description:
      "검은 얼굴과 주걱 모양 부리가 특징인 멸종위기 물새예요. 아시아 연안 습지에서 겨울을 보냅니다.",
    imageUrl: W("b/b3/Black-faced_Spoonbill_1.jpg", "Black-faced_Spoonbill_1.jpg"),
  ...
  백로: {
    ...
    imageUrl: W("5/57/Ardea_alba4.jpg", "Ardea_alba4.jpg"),
    imageCredit: "Wikimedia Commons",
  },
  왜가리: {
    koreanName: "왜가리",
    ...
    imageUrl: W(
      "9/9e/Grey_Heron_%28Ardea_cinerea%29_standing_in_the_river_%28square%29.jpg",
      "Grey_Heron_%28Ardea_cinerea%29_standing_in_the_river_%28square%29.jpg",
    ),
    imageCredit: "Wikimedia Commons",
  },
  도요새: {
  ...
  황새: {
    ...
    imageUrl: W(
      "4/40/Ciconia_boyciana_-_Changnyung_Habitat.jpg",
      "Ciconia_boyciana_-_Changnyung_Habitat.jpg",
    ),
    imageCredit: "Wikimedia Commons",
  },
  가마우지: {
    ...
    imageUrl: W("b/ba/Branta_bernicla1.jpg", "Branta_bernicla1.jpg"),
    imageCredit: "Wikimedia Commons",
  },
  큰유리: {
    koreanName: "큰유리",
    ...
    imageUrl: W("1/1e/Cygnus_cygnus_1.jpg", "Cygnus_cygnus_1.jpg"),
    imageCredit: "Wikimedia Commons",
  },
  재갈매기: {
    koreanName: "재갈매기",
    ...
    imageUrl: W("8/8e/Larus_crassirostris_1.jpg", "Larus_crassirostris_1.jpg"),
    imageCredit: "Wikimedia Commons",
  },
  멧도요: {
    koreanName: "멧도요",
    ...
    imageUrl: W("9/9a/Tringa_totanus_-_Laem_Pak_Bia.jpg", "Tringa_totanus_-_Laem_Pak_Bia.jpg"),
    imageCredit: "Wikimedia Commons",
  },
  흰뺨검둥오리: {
    koreanName: "흰뺨검둥오리",
    ...
    imageUrl: W(
      "a/a7/Aythya_ferina_male_%28lake%29%2C_Leighton_Moss%2C_Lancashire%2C_UK.jpg",
      "Aythya_ferina_male_%28lake%29%2C_Leighton_Moss%2C_Lancashire%2C_UK.jpg",
    ),
    imageCredit: "Wikimedia Commons",
  },
  말새: {
    ...
    imageUrl: W("4/4e/Falco_subbuteo_1.jpg", "Falco_subbuteo_1.jpg"),
    imageCredit: "Wikimedia Commons",
  },
  송골매: {
    koreanName: "송골매",
    ...
    imageUrl: W("4/4e/Accipiter_nisus_male.jpg", "Accipiter_nisus_male.jpg"),
    imageCredit: "Wikimedia Commons",
  },
  독수리: {
    koreanName: "독수리",
    ...
    imageUrl: W("f/fa/Haliaeetus_albicilla_2.jpg", "Haliaeetus_albicilla_2.jpg"),
  ...
  황조롱이: {
    ...
    imageUrl: W("2/2e/Falco_tinnunculus_male_2.jpg", "Falco_tinnunculus_male_2.jpg"),
    imageCredit: "Wikimedia Commons",
  },
  원앙: {
    koreanName: "원앙",
    ...
    imageUrl: W("b/b8/Aix_galericulata_male.jpg", "Aix_galericulata_male.jpg"),
    imageCredit: "Wikimedia Commons",
  },
  물닭: {
    koreanName: "물닭",
    ...
    imageUrl: W(
      "c/c6/Common_Moorhen_%28Gallinula_chloropus%29.jpg",
      "Common_Moorhen_%28Gallinula_chloropus%29.jpg",
    ),
    imageCredit: "Wikimedia Commons",
  },
  쇠물닭: {
    ...
    imageUrl: W("b/b8/Tachybaptus_ruficollis_1.jpg", "Tachybaptus_ruficollis_1.jpg"),
    imageCredit: "Wikimedia Commons",
  },
  청둥오리: {
    koreanName: "청둥오리",
    ...
    imageUrl: W(
      "9/9a/Baikal_Teal_%28Sibirionetta_formosa%29_male.jpg",
      "Baikal_Teal_%28Sibirionetta_formosa%29_male.jpg",
    ),
    imageCredit: "Wikimedia Commons",
  },
  "참새류": {
    ...
    imageUrl: W("5/5e/Passer_montanus.jpg", "Passer_montanus.jpg"),
  ...
  울새: {
    ...
    imageUrl: W("8/8e/Parus_variabilis.jpg", "Parus_variabilis.jpg"),
    imageCredit: "Wikimedia Commons",
  },
  까치: {
    koreanName: "까치",
    ...
    imageUrl: W("4/4e/Pica_pica_1.jpg", "Pica_pica_1.jpg"),
    imageCredit: "Wikimedia Commons",
  },
  천둥오리: {
    koreanName: "천둥오리",
    ...
    imageUrl: W("8/8e/Tadorna_tadorna_1.jpg", "Tadorna_tadorna_1.jpg"),
    imageCredit: "Wikimedia Commons",
  },
  알락오리: {
    koreanName: "알락오리",
    ...
    imageUrl: W("5/5e/Anas_crecca_male.jpg", "Anas_crecca_male.jpg"),
    imageCredit: "Wikimedia Commons",
  },
  노랑부리저어새: {
    koreanName: "노랑부리저어새",
    ...
    imageUrl: W("6/6e/Numenius_madagascariensis.jpg", "Numenius_madagascariensis.jpg"),
    imageCredit: "Wikimedia Commons",
  },
  큰고니: {
    koreanName: "큰고니",
  ...
  세가락갈매기: {
    ...
    imageUrl: W("4/4e/Rissa_tridactyla_1.jpg", "Rissa_tridactyla_1.jpg"),
    imageCredit: "Wikimedia Commons",
  },
  괭이갈매기: {
    koreanName: "괭이갈매기",
    ...
    imageUrl: W("8/8e/Larus_schistisagus_1.jpg", "Larus_schistisagus_1.jpg"),
    imageCredit: "Wikimedia Commons",
  },
  붉은부리갈매기: {
    koreanName: "붉은부리갈매기",
    ...
    imageUrl: W("8/8e/Chroicocephalus_ridibundus_1.jpg", "Chroicocephalus_ridibundus_1.jpg"),
    imageCredit: "Wikimedia Commons",
  },
  붉은머리오목눈이: {
    koreanName: "붉은머리오목눈이",
    ...
    imageUrl: W("8/8e/Mergus_serrator_male.jpg", "Mergus_serrator_male.jpg"),
    imageCredit: "Wikimedia Commons",
  },
  흑두루미: {
    koreanName: "흑두루미",
    ...
    imageUrl: W("8/8e/Grus_monacha_1.jpg", "Grus_monacha_1.jpg"),
    imageCredit: "Wikimedia Commons",
  },
  쇠기러기: {
    koreanName: "쇠기러기",
    ...
    imageUrl: W("5/5e/Anser_fabalis_1.jpg", "Anser_fabalis_1.jpg"),
    imageCredit: "Wikimedia Commons",
  },
  재두루미: {
    koreanName: "재두루미",
    ...
    imageUrl: W("8/8e/Grus_vipio_1.jpg", "Grus_vipio_1.jpg"),
    imageCredit: "Wikimedia Commons",
  },
};
